...
MAX_WORKERS = 8 # max threads at a time

gainRatio = 1.3 # takeProfit = -stopLoss*gainRatio
stopLossMargin = 0.05 # extra margin for the stop loss

operEquity = 62.5 # defines the target amount per execution ($)
...
PATTERN_DAY_TRADE_PROTECTION=True
